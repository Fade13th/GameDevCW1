...
public class Tutorial : MonoBehaviour {
	...
	private void UpdateTutorial () {
		switch(stage) {
            case 0 :
                text.text = "Welcome. This tutorial will introduce you to the basics of survival. You can close the tutorial at any time by pressing 'Quit'. Press 'Esc' to unlock the mouse and click the arrow button to continue.";
                enableNext(true);
			break;

			case 1:
				text.text = "You can look around using the mouse, and move with W, A, S and D. You can also use Shift to sprint.";
				water_highlight.enabled = false;
				break;
			...
			case 4:
				text.text = "This is your health. The lower your health is, the more slowly your energy will recharge. If this bar reaches 0, you will die.";
            ...
            case 10:
                text.text = "Now you have water, you'll need to build tools to survive in the wilderness. The first step is to gather rocks to use as a makeshift tool and for use in crafting. Pick up items in the world by walking over them. \n\nObjective: Find a rock.";
                water_highlight.enabled = false;
                waiting = true;
                targetItem = "Dwayne";
                waitFunc = WaitForItem;
            ...
            case 16:
                text.text = "Some animals also drop useful byproducts like leather. Make sure to collect it: you don't know when it'll come in handy. \n\nObjective: Collect leather from your recent kill";
                waiting = true;
                targetItem = "Leather";
                waitFunc = WaitForItem;
                break;
